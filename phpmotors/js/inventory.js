...
function buildInventoryList(data) {
    ...
    data.forEach(function (element) {
        ...
        dataTable += `<td><a class='link green-link' href='/CSE340/phpmotors/vehicles?action=mod&invId=${element.invId}' title='Click to modify'>Modify</a></td>`;
        dataTable += `<td><a class='link red-link' href='/CSE340/phpmotors/vehicles?action=del&invId=${element.invId}' title='Click to delete'>Delete</a></td></tr>`;
    })
    dataTable += '</tbody>';
