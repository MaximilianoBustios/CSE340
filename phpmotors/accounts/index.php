...
switch ($action) {
    ...
    case 'register':
        ...
        if($existingEmail){
            $message = '<p class="notice">The email address already exists. Do you want to login instead?</p>';
    ...
    case 'update-password':
        ...
        if(empty($checkPassword)){
            $passwordMessage = "<p class='error-message'>Please enter a valid password.</p>";
            include '../view/client-update.php';
            exit; 
        }
        ...
        // Check and report the result
        if($updateOutcome === 1){
            $passwordMessage = "The password has been updated succesfully.<br><br>";
            include '../view/client-update.php';
            exit;
        } else {
            $passwordMessage = "<p>Sorry, but the updating failed. Please try again.</p>";
            include '../view/client-update.php';
            exit;
        }
        break;
