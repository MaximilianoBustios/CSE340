<?php
//Function for inserting news classifications
...
//Function for inserting new vehicles
function insertNewVehicle($invMake, $invModel, $invDescription, $invImage, $invThumbnail, $invPrice, 
...
// This function update the vehicles information
function updateVehicle($invId, $invMake, $invModel, $invDescription, $invImage, $invThumbnail, $invPrice, 
$invStock, $invColor, $classificationId) {
    $db = phpmotorsConnect(); 
...
// this function delete a vehicle from the database
...
//The next function will get a list of vehicles based on the classification
